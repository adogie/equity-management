...
const setting = {
  ...
  publicPath: process.env.NODE_ENV === 'development' ? '/' : '/jchc-invest/',
  // 生产环境构建文件的目录名
  outputDir: 'dist',
  ...
  loadingText: '正在加载中...',
  // token名称
  tokenName: 'micro-token',
  // token在localStorage、sessionStorage、cookie存储的key的名称
  tokenTableName: 'micro-token',
  ...
  defaultOpeneds: ['/vab'],
  // 不需要加loading层的请求，防止重复提交
  debounce: ['aggregation', 'user', 'zTreeNodes'],
  // 需要自动注入并加载的模块
  providePlugin: {},
